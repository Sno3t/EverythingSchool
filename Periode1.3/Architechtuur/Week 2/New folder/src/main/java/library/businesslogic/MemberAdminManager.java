...
public class MemberAdminManager {
    ...
    private void fillTestData()
    {
        ...
        Member aNewMember = new Member(1000, "Pascal", "van Gastel");
        ...
        aNewMember = new Member(1001, "Erco", "Argante");
        members.add(aNewMember);
        c.setTime(dateToday);
        ...
        aNewMember = new Member(1002, "Jan", "Montizaan");
        members.add(aNewMember);
        ...
        aNewMember = new Member(1003, "Johan", "Smarius");
        aNewMember.setFine(5.25);
        members.add(aNewMember);

        members.add(new Member(1004, "Arno", "Broeders"));
    }
